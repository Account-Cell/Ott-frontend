...
const VideoItem = (props) => {
  ...
  const { roomId = 'defaultRoom', token = 'defaultToken', videoId = 1 } = location.state || {};
        ...
        stompClient.connect(
          ...
          () => {
            ...
            stompClient.send(
              ...
              headers,
              JSON.stringify({ requesterId: token })
            );
  ...
  return (
    <div className="video-item-container">
      <img src='http://localhost:3000/img/test5.jpeg' alt="Video Thumbnail" />
      <div className='video-exp'>1화 솰라솰라솰라</div>
      ...
      <video
        ...
        width="600"
        style={{ display: connected ? 'block' : 'none', marginTop: '10px' }}
      />
